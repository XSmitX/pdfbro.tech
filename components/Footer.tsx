...
const FOOTER_LINKS: Record<string, { label: string; href: string }[]> = {
  ...
  "Convert": [
    ...
    { label: "GIF to MP4", href: "/tools/gif-to-mp4" },
  ...
  "Guides": [
    ...
    { label: "Compress Images Online", href: "/guides/how-to-compress-images-online" },
    ...
    { label: "Remove Background Guide", href: "/guides/how-to-remove-image-background" },
    { label: "iLovePDF Alternative", href: "/guides/ilovepdf-alternative" },
    { label: "Smallpdf Alternative", href: "/guides/smallpdf-alternative" },
