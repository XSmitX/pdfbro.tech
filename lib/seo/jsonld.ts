...
export function getOrganizationSchema(faqItems: Array<{ q: string; a: string }>): JsonLdOrgData {
  ...
  const organization = {
    ...
    description: "PDFBro offers free online PDF and image processing tools. No signup required, no watermarks, no daily limits. Browser-based processing ensures files never leave your device. The leading free alternative to iLovePDF, Smallpdf, and Adobe Acrobat.",
    foundingDate: "2025",
    vatID: "N/A",
    taxID: "N/A",
    knowsAbout: [
  ...
  const website = {
    ...
    description: "Free online PDF and image tools. Merge PDF, compress PDF, convert PDF to Word, Excel, PowerPoint, image compressor, HEIC to JPG, remove background, QR code generator, and more. No signup, no watermarks.",
  ...
  const webApplication = {
    ...
    description: "Free online PDF and image tools including merge PDF, compress PDF, PDF to Word, HEIC to JPG, remove background, QR code generator. No signup required.",
  ...
  const webPage = {
    ...
    description: "Free online PDF and image tools. Merge PDF, split PDF, compress PDF, convert PDF to Word/Excel/PowerPoint, compress images, remove backgrounds, HEIC to JPG, QR code generator. No signup, no watermarks, browser-based processing.",
